...
{
    // Windows: C:\Users\Username\AppData\Local\quantum-testnet
    // macOS: ~/Library/Application Support/quantum-testnet
    // Unix-like: ~/.quantum-testnet
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_LOCAL_APPDATA) / "quantum-testnet";
#else
    fs::path pathRet;
...
#ifdef __APPLE__
    // macOS
    return pathRet / "Library/Application Support/quantum-testnet";
#else
    // Unix-like
    return pathRet / ".quantum-testnet";
#endif
#endif
}
