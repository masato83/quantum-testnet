...
extern const std::string WALLETDESCRIPTORMLDSACACHE;
...
public:
    ...
    bool WriteDescriptorMLDSACache(const std::vector<unsigned char>& pubkey, const uint256& desc_id, uint32_t der_index);
