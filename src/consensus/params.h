...
constexpr bool ValidDeployment(BuriedDeployment dep) { return dep <= DEPLOYMENT_QUANTUM; }
...
struct Params {
    ...
    int SegwitHeight;
    /** Block height at which P2TSH (BIP360) becomes active. */
    int QuantumHeight;
