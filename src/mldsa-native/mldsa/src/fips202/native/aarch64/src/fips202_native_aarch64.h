...
void mld_keccak_f1600_x1_scalar_asm(uint64_t* state, uint64_t const* rc)
    __contract__(
        requires(memory_no_alias(state, sizeof(uint64_t) * 25 * 1)) requires(rc == mld_keccakf1600_round_constants)
...
void mld_keccak_f1600_x2_v84a_asm(uint64_t* state, uint64_t const* rc)
    __contract__(
        requires(memory_no_alias(state, sizeof(uint64_t) * 25 * 2)) requires(rc == mld_keccakf1600_round_constants)
...
void mld_keccak_f1600_x4_scalar_v8a_hybrid_asm(uint64_t* state,
                                               uint64_t const* rc)
    __contract__(
        requires(memory_no_alias(state, sizeof(uint64_t) * 25 * 4)) requires(rc == mld_keccakf1600_round_constants)
