...
void mld_keccakf1600_extract_bytes(uint64_t* state, unsigned char* data,
    ...
    __contract__(
        requires(0 <= offset && offset <= MLD_KECCAK_LANES * sizeof(uint64_t) &&
                 0 <= length && length <= MLD_KECCAK_LANES * sizeof(uint64_t) - offset) requires(memory_no_alias(state, sizeof(uint64_t) * MLD_KECCAK_LANES)) requires(memory_no_alias(data, length))
...
void mld_keccakf1600x4_extract_bytes(uint64_t* state, unsigned char* data0,
    ...
    __contract__(
        requires(0 <= offset && offset <= MLD_KECCAK_LANES * sizeof(uint64_t) &&
                 0 <= length && length <= MLD_KECCAK_LANES * sizeof(uint64_t) - offset) requires(memory_no_alias(state, sizeof(uint64_t) * MLD_KECCAK_LANES * MLD_KECCAK_WAY)) requires(memory_no_alias(data0, length)) requires(memory_no_alias(data1, length)) requires(memory_no_alias(data2, length)) requires(memory_no_alias(data3, length))
...
void mld_keccakf1600x4_xor_bytes(uint64_t* state, const unsigned char* data0,
    ...
    __contract__(
        requires(0 <= offset && offset <= MLD_KECCAK_LANES * sizeof(uint64_t) &&
                 0 <= length && length <= MLD_KECCAK_LANES * sizeof(uint64_t) - offset) requires(memory_no_alias(state, sizeof(uint64_t) * MLD_KECCAK_LANES * MLD_KECCAK_WAY)) requires(memory_no_alias(data0, length))
