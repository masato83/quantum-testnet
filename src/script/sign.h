...
public:
    ...
    virtual bool CreateMLDSASig(const SigningProvider& provider, std::vector<unsigned char>& sig, std::span<const unsigned char> pubkey, const uint256* leaf_hash, SigVersion sigversion) const = 0;
